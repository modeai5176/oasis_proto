      ...
      <div className="min-h-screen">
        ...
        <div className="bg-[#00071B] border-b border-[#2D8C7E] shadow-lg">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <SiteBreadcrumb items={breadcrumbConfigs.about} />
          </div>
        </div>
        {/* Hero Section */}
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="mb-8 slide-in-top">
                <div className="w-24 h-24 bg-[#D6B585] rounded-full flex items-center justify-center mx-auto mb-6 shadow-2xl">
                  <Target className="h-12 w-12 text-[#1C3163]" />
                </div>
              </div>
              ...
              <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight drop-shadow-lg slide-in-top">
                Our Mission & <span className="text-[#D6B585]">Vision</span>
              </h1>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-[#00071B] max-w-3xl mx-auto slide-in-top">
                We envision a global village where intergenerational connections
                flourish, integrity is never compromised, and every voice is
                heard.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <Card className="text-center hover-slide-up card-slide-left group hover:shadow-2xl hover:scale-105 transition-all duration-500">
                ...
                <CardContent>
                  <p className="text-[#00071B] leading-relaxed group-hover:text-[#1C3163] transition-colors duration-300">
                    Building connections across cultures, generations, and
                    communities worldwide, creating a network of support and
                    understanding.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="text-center hover-slide-up card-slide-top group hover:shadow-2xl hover:scale-105 transition-all duration-500">
                ...
                <CardContent>
                  <p className="text-[#00071B] leading-relaxed group-hover:text-[#1C3163] transition-colors duration-300">
                    Bridging the gap between generations, sharing wisdom, and
                    creating spaces where all ages learn from and support each
                    other.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="text-center hover-slide-up card-slide-right group hover:shadow-2xl hover:scale-105 transition-all duration-500">
                ...
                <CardContent>
                  <p className="text-[#00071B] leading-relaxed group-hover:text-[#1C3163] transition-colors duration-300">
                    Maintaining the highest standards of trust, respect, and
                    ethical conduct in everything we do, without exception.
                  </p>
                </CardContent>
              </Card>
            </div>
        ...
        <section className="py-20 bg-[#F8F9FA]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-[#00071B] max-w-3xl mx-auto slide-in-top">
                We focus on changes "from the inside out" - helping participants
                become confident, dream big, and achieve their goals.
              </p>
            </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <p className="text-[#00071B] text-lg">
                      Homemakers and seniors becoming confident in organizing
                    </p>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle className="h-6 w-6 text-[#1C3163] mt-1 flex-shrink-0" />
                    <p className="text-[#00071B] text-lg">
                      Overcoming skill challenges and becoming self-reliant
                    </p>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle className="h-6 w-6 text-[#1C3163] mt-1 flex-shrink-0" />
                    <p className="text-[#00071B] text-lg">
                      Participants becoming confident organizers
                    </p>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle className="h-6 w-6 text-[#1C3163] mt-1 flex-shrink-0" />
                    <p className="text-[#00071B] text-lg">
                      Dreaming big and setting achievable goals
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="slide-in-right">
                <div className="bg-[#1C3163] p-8 rounded-2xl text-[#FEFFFF]">
                  ...
                  <p className="text-lg leading-relaxed mb-6">
                    We measure success not by numbers, but by the quality of
                    changes, the enthusiasm of participants, and the lasting
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-[#D6B585] max-w-3xl mx-auto slide-in-top">
                A senior community member whose life was transformed through our
                support
              </p>
            </div>
              ...
              <Card className="bg-[#1C3163] border-[#D6B585] hover-slide-up">
                <CardContent className="p-8">
                  ...
                  <div className="space-y-4 text-[#FEFFFF] text-lg leading-relaxed">
                    <p>
                      Pradeep Berry, a senior community member, came to us
                      facing significant challenges. Through our comprehensive
                      support system, we provided assistance until long-term
                      solutions were available.
                    </p>
                    <p>
                      Today, Pradeep has become a confident organizer and active
                      participant in our community, demonstrating the
                      transformative power of sustained support and belief in
                      one's potential.
                    </p>
                    <p className="text-[#D6B585] font-semibold text-center">
                      "The miracle is accepting them the way they are, offering
                      respect and love."
                    </p>
                  </div>
                </CardContent>
        ...
        <section className="py-20 bg-[#FEFFFF]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-[#00071B] mb-8 max-w-3xl mx-auto slide-in-top">
              Join us in creating a world where every voice matters and every
              dream has the support to flourish.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center slide-in-bottom">
              ...
              >
                <Link href="/contribute">Support Our Mission</Link>
              </Button>
            </div>
          </div>
        </section>
